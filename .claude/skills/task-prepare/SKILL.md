...
2. 必要なら `AskUserQuestion` で次を確認する
   - 今回の目的
   ...
   - 何を変えてはいけないか
   - 完了条件は何か
3. `.claude/skills/_shared/execution-modes.md` を参照し、後続 task をどう進めるかと、どこで確認を挟むかを task に記録する
...
- 必要な確認を通常会話だけで済ませず、可能なら `AskUserQuestion` を使う
