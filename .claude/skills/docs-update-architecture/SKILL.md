...
- `.claude/skills/docs-update-architecture/references/best-practices.md`
- `.claude/skills/docs-update-architecture/references/architecture.template.md`
- 関連 spec / ADR / validation / tech-stack

## やること

1. 必要なら `AskUserQuestion` で変更意図、背景、影響範囲を確認する
