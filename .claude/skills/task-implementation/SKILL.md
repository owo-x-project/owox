...
- `.agents/project.md`
- `.claude/skills/_shared/task-template.md`
- `.claude/skills/_shared/reference-order.md`
- `.claude/skills/_shared/document-update-checklist.md`
- `.claude/skills/_shared/trace-tags.md`
- `.claude/skills/_shared/execution-modes.md`
- `.claude/skills/_shared/request-user-input-policy.md`
...
2. 必要なら `AskUserQuestion` で `目的`、`進め方`、変更可能範囲、完了条件を確認する
3. `.claude/skills/_shared/execution-modes.md` を参照し、今回を `自走` か `対話` のどちらで進めるかと、どこで確認を挟むかを task に残す
...
- 高リスク変更や仕様変更が必要なら `AskUserQuestion` を使う
