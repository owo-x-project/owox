# owox Requirements v0

## 役割

`owox` v0 は AI Agent First な WebUI ベース Terminal Workspace / 簡易 IDE の要求正本です。owox workspace root 配下の project list、terminal session、任意 command としての AI CLI、log、Git、file tree、簡易 editor、diff を対象にします。
...
- `REQ-agent-session-runtime.md`: 非推奨。v0 の AI CLI / agent process 扱いは `REQ-terminal-workspace.md` に吸収
