...
- `.agents/project.md`
- `.github/skills/_shared/task-template.md`
- `.github/skills/_shared/reference-order.md`
- `.github/skills/_shared/document-update-checklist.md`
- `.github/skills/_shared/trace-tags.md`
- `.github/skills/_shared/execution-modes.md`
- `.github/skills/_shared/request-user-input-policy.md`
...
2. 必要なら `ask_user` で `目的`、`進め方`、変更可能範囲、完了条件を確認する
3. `.github/skills/_shared/execution-modes.md` を参照し、今回を `自走` か `対話` のどちらで進めるかと、どこで確認を挟むかを task に残す
