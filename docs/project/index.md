...
- `architecture.md`: 不変条件、責務分離、正本配置、設計方針
...
- `tech-stack.md`: 採用技術一覧と正本 / projection 技術
- `validation.md`: v0 acceptance、Handoff、schema、API、projection rebuild、crate 境界、Workbench 状態表示の検証方針
